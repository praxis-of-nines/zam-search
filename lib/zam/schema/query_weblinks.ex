defmodule Zam.Schema.QueryWeblinks do
  ...
  alias Zam.Schema.{Weblink, Image, Index, Webdomain, TextBlob, Definition, Bookmark, ResponseLog}
  ...
  def create_image(%{} = attrs), do: %Image{} |> Image.changeset(attrs) |> Repo.insert()
